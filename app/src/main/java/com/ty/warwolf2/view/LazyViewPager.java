...
public class LazyViewPager extends ViewGroup {
    ...
    private boolean mSupportScroll = true;//是否支持滑动
    ...
    void dataSetChanged() {
        // This method only gets called if our observer is attached, so mUsersAdapter
        // is non-null.
