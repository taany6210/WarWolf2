...
import com.ty.warwolf2.base.App;


/**
 * @ 文件名:   SpannableStringUtils
 * @ 创建者:   ty
 * @ 时间:    2017/8/2 下午2:39
 * @ 描述:
 */
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(App.sContext, bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(App.sContext, uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(App.sContext, resourceId), start, end, flag);
                    resourceId = 0;
