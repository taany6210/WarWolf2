...
public abstract class BaseFragment extends Fragment {
    ...
    public View getBaseView() {
        return mActivity == null ? null : mActivity.getBaseView();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        mBaseView = LayoutInflater.from(getContext()).inflate( R.layout.fragment_base, null, false);
        mInflater = inflater;
        LinearLayout layout = (LinearLayout) mBaseView;
        if (mPager == null) {
            mPager = new LoadingPager(mActivity) {
                @Override
                protected View onCreateSuccessView() {
                    mView = LayoutInflater.from(getContext()).inflate(BaseFragment.this.getLayoutId(), null, false);
